  ...
  async function loadStats() {
    try {
      ...
      if (trabalhos) {
        ...
        // Trabalhos em andamento (somente aceitos)
        const emAndamento = trabalhos.filter((t: any) => 
          ['aceito', 'em_andamento'].includes(t.status)
        );
        setTrabalhosEmAndamento(emAndamento.slice(0, 10));
              ...
              <div className="card mb-6">
                ...
                {trabalhosEmAndamento.length === 0 ? (
                  ...
                  <div className="space-y-3">
                    {trabalhosEmAndamento.map((trabalho: any) => {
